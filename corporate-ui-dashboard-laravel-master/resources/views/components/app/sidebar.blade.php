<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            href="/dashboard">
            <span class="font-weight-bold text-lg">App Medico</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <!--Objeto de la lista: Menu Principal-->
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Menu Princial</span>
                </a>
            </li>
            <!--Objeto de la lista: Tabels -> Pacientes-->
            <li class="nav-item">
            ...
            <!--Objeto de la lista: Wallet -> Citas-->
            <li class="nav-item">
            ...
            <!--Objeto de la lista: RTL -> Servicios-->
            <li class="nav-item">
